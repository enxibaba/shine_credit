...
//              setAvatarDataForContactIfAvailable(c);
  ...
  private ArrayList<Contact> getContactsFrom(Cursor cursor, boolean localizedLabels) {
    ...
    while (cursor != null && cursor.moveToNext()) {
      ...
      // 查询联系人添加时间
      contact.contactTimes = cursor.getInt(cursor.getColumnIndex(ContactsContract.Contacts.TIMES_CONTACTED));
      contact.times = cursor.getLong(cursor.getColumnIndex(ContactsContract.Contacts.CONTACT_LAST_UPDATED_TIMESTAMP));
      //NAMES
