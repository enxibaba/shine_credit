...
class Colours {
  ...
  static const Color login_bg = Color(0x1A000000);

  static const Color text_regular = Color(0xFF666666);
  static const Color dark_text_regular = Color(0xFFB8B8B8);
  ...
  static const Color button_disabled = Color(0x4D0B6DFF);
  static const Color dark_button_disabled = Color(0xFF83A5E0);

  static const Color app_main_bg = Color(0x1A0B6DFF);
  ...
  static const Color gradient_blue = Color(0xFF60B3FF);
  static const Color shadow_blue = Color(0x805793FA);
  static const Color orange = Color(0xFFFF8547);

  static const Color apply_tips_color = Color(0xFFEDF4FF);
}
